    ...
    function SlickLightbox(element, options) {
      ...
      this.element.on(
        ...
        function (e) {
          e.preventDefault();
          return that.init(
            that.element.find(that.options.itemSelector).index($(this))
          );
        }
      );
    }
    ...
    SlickLightbox.prototype.createModalItems = function (index) {
      ...
      if (this.options.images) {
        links = $.map(this.options.images, function (img) {
          return (
            '<div class="slick-lightbox-slick-item"><div class="slick-lightbox-slick-item-inner"><img class="slick-lightbox-slick-img" src="' +
            img +
            '" /></div></div>'
          );
        });
        ...
        createItem = (function (_this) {
          return function (el) {
            ...
            if (_this.detectImage(src)) {
              ...
              return (
                '<div class="slick-lightbox-slick-item"><div class="slick-lightbox-slick-item-inner iframe"><div class="slick-lightbox-slick-iframe-wrap"><iframe class="slick-lightbox-slick-iframe" src="' +
                src +
      ...
      resizeSlides = (function (_this) {
        return function () {
          ...
          return _this.modalElement
            .find(".slick-lightbox-slick-img")
            .css("max-height", Math.round(0.9 * h));
        };
      })(this);
      $(window).on(
